...
namespace MdallWebApi.Controllers
{
    public class DeviceIdentifierController : ApiController
    {
        ...
        public IEnumerable<DeviceIdentifier> GetAllDeviceIdentifier(string device_identifier = "", int licence_id = 0, int device_id = 0)
        {

            return databasePlaceholder.GetAll(device_identifier, licence_id, device_id);
        }
